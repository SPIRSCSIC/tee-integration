...
// Even it is C code it is compiled using a C++ compiler
// thus `extern "C"` is needed for calling this function from pure C code (eg. ta_callbacks.c)
extern "C" int pairings_test(char *aStr, char *bStr)
{
    int g_err = 0;
    char buf[1600];
    // const char *aStr = "123";
